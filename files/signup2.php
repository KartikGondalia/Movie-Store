    ...
    <div class="main">
        ...
        <div class="container">
            <div class="signup-content">
                <form method="POST" id="signup-form" class="signup-form" action="includes/signup2.inc.php">
                    <h2>Sign up For Netflix Admin </h2>
                    <p class="desc"></p>
                    ...
                    <div class="form-group">
                        ...
                        <a href="admin_login.php" class="submit-link submit">Sign in</a>
                    </div>
                </form>
            </div>
        </div>
